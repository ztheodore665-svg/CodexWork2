...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash\bfseries\color{AttackBlue}}m{0.22\textwidth}>{\raggedright\arraybackslash}X}
  ...
  \midrule
  学校名称 & 中山大学 \\
  队长姓名 & 曾国财 \qquad 联系电话：13128762859 \\
  团队成员（含队长共5人） & 1.曾国财 \quad 2.王涛 \quad 3.翁嘉 \quad 4.李佳君 \quad 5.陈信先 \\
  指导教师 & 林丹 \\
  \bottomrule
\end{tabularx}
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{0.25\textwidth}p{0.3\textwidth}X}
  \toprule
  平台或服务名称 & 版本或网络 & 用途 \\
  \midrule
...
\begin{tabularx}{\textwidth}{p{0.48\textwidth}X}
  队长签字：\raisebox{-0.28\height}{\includegraphics[width=31mm,trim=45 35 45 35,clip]{captain-signature.jpg}} & 日期：2026 年 9 月 24 日 \\
\end{tabularx}
